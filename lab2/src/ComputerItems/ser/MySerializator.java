...
//                    c.accept();
    ...
    private static Object createPrimitiveObject(Class className, String value) throws NoSuchMethodException, ClassNotFoundException, IllegalAccessException, InvocationTargetException {
    ...
    private static StringBuilder readFromFile(BufferedInputStream in) throws IOException, ClassNotFoundException {
        int st;
